            ...
            <div class="card-body p-5">
              ...
              <form action="{{ route('register') }}" method="POST">
                ...
                <div class="d-flex justify-content-center">
                  <button  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block btn-lg gradient-custom-4 ">Register</button>
                </div>

                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="#!"
                    class="fw-bold text-body"><a href={{ route('login') }}><u>Login here</u></a></p>
